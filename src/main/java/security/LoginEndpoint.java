...
public class LoginEndpoint {
    ...
    private String createToken(int id, String userName, List<String> roles) throws JOSEException {
        ...
        String issuer = "Kofoednet.systems";
    ...
    //Endpoints for testing during deployment
    @GET
    @Path("serverTest")
    @Produces({MediaType.APPLICATION_JSON})
    public Response serverTest() {
        String ok ="Server is up";
...
//    }
    ...
    @GET
    @Path("testAdminAccess")
    @RolesAllowed({"admin", "superuser"})
    @Produces({MediaType.APPLICATION_JSON})
    public Response testUserAccess() {
        String ok ="Server is up";
        return Response.ok(ok).build();
    }
